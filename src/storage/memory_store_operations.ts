...
export type MutableMergeGraphState = Omit<MutableGraphState, "purgeManifests">;
...
export type MutableWorkLifecycleState = Omit<
	MutableGraphState,
	"systemRelations" | "aliases" | "relationTypeDefinitions"
>;
