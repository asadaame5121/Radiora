...
export const Unsaved: Story = { args: { status: { workId: "work-1", branchId: "branch-1", phase: "unsaved" } } };
export const Saving: Story = { args: { status: { workId: "work-1", branchId: "branch-1", phase: "saving" } } };
export const Failed: Story = {
	args: { status: { workId: "work-1", branchId: "branch-1", phase: "failed", error: "保存先へ書き込めませんでした。" } },
